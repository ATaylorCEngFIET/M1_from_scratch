...
HD_PWD='C:/hdl_projects/m1_from_scratch/m1_from_scratch.runs/design_1_CORTEXM1_AXI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_CORTEXM1_AXI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_CORTEXM1_AXI_0_0.tcl
